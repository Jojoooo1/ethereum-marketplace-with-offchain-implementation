...
import { getProductByStoreAddress, newProduct, removeProduct, updateStore, updateProduct } from "../../actions/index";
...
const mapDispatchToProps = dispatch => ({
  ...bindActionCreators({ getProductByStoreAddress, newProduct, updateProduct, removeProduct, updateStore }, dispatch)
});
